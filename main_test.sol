...
contract coursepaper {
    ...
    constructor() public {
        ...
        //Shops
        shopLists["Beer"] = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;
        structShops[0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2] = structShop("Beer", get_hash("2"), 1000, 3, false, "1", "Moscow", 0);
        shopList.push(structShops[0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2].shopName);
        shopLists["Product"] = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db;
        structShops[0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db] = structShop("Product", get_hash("2"), 1000, 3, false, "2", "Petersburg", 0);
        shopList.push(structShops[0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db].shopName);

        //User
        structUserLogins["Peta"] = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;
        structUsers[0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB] = structUser("Peta", get_hash("3"), 1000, 2, false);
        userLoginsArray.push("Peta");
        userAddressArray.push(0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB);
    }
//END CONSTRUCTOR
